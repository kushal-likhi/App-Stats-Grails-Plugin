...
var demo = {
    console: {
        ...
        init_console_jsBuild_generated: function() {
            demo.console.Constructor()
        }
    },
    Constructor: function() {
    },
    init_demo_jsBuild_generated: function() {
        demo.Constructor()
    },
    MasterConstructor_jsBuild_generated: new function() {
        window.onload = function() {
            ...
            window.log = function(str) {
                try {
                    demo.console.log(str, 'white')
                } catch(c) {
                }
            };
            window.watch = function(k, v) {
                try {
                    demo.console.watch(k, v)
                } catch(c) {
                }
            };
            ...
            try {
                document.getElementById('osecin').onkeydown = demo.console.eventHandlers.executeCommand
            } catch(c) {
            }
            try {
                document.getElementById('consoleShowHideButton').onclick = demo.console.eventHandlers.consoleshowHide
            } catch(c) {
            }
        }
    }
