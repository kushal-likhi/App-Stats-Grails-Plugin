var demo = {console:{getFunc:function(b) {
    a.evalOSD1234 = "" + b
    ...
    b.style.top = "60%";
    b.id = "osehbc";
    b.innerHTML = "<h4 style='padding:0px;margin:0px' align='center'>JSB Console</h4><button style='padding:0px;margin:0px;float:right;position:absolute;top:0%;width:8%;left:90%' id='consoleShowHideButton'>Show/Hide</button>";
    document.getElementsByTagName("body").item(0).appendChild(b);
...
},eventHandlers:{executeCommand:function(e) {
    if (e.keyCode == 13) {
    ...
    c.style.left = "15%";
    c.id = "osedit";
    c.innerHTML = "<textarea id='ostaed' style='width:100%;height:90%;background:#ffc'></textarea><br><button onclick=\"demo.console.updateFunc('" + e + "')\">Update</button><button onclick='demo.console.closeEditor()'>Close</button>";
    document.getElementsByTagName("body")[0].appendChild(c);
    var b = document.getElementById("ostaed");
    if (!b) {
        demo.console.log("not Found")
    }
    b.innerHTML = b.innerHTML + d
},ex:{},log:function(d, c) {
    d = "$(" + new Date().getHours() + ":" + new Date().getMinutes() + ":" + new Date().getSeconds() + ")> <span style='color:" + c + "'>" + d + "</span>";
    var b = document.getElementById("osecta");
    b.innerHTML = b.innerHTML + d + "<br>";
    b.scrollTop = b.scrollHeight
},a:{},Constructor:function() {
    demo.console.ui.buildUI();
    demo.console.expanded = true;
    demo.console.currentIndex = demo.console.stack.length
},stack:new Array(),closeEditor:function() {
    ...
    window.onload = function() {
        ...
        window.log = function(d) {
            try {
                demo.console.log(d, "white")
            } catch(e) {
            }
        };
        window.watch = function(e, d) {
            try {
                demo.console.watch(e, d)
            } catch(f) {
            }
        };
